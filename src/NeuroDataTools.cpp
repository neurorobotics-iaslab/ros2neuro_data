#ifndef ROS2NEURO_NEURODATA_TOOLS_CPP
#define ROS2NEURO_NEURODATA_TOOLS_CPP
...
bool NeuroDataTools::ConfigureNeuroFrame(const ros2neuro_msgs::msg::NeuroFrame& msg, NeuroFrame& frame) {
...
bool NeuroDataTools::FromNeuroInfo(const NeuroDataInfo& info, ros2neuro_msgs::msg::NeuroDataInfo& msg) {
...
bool NeuroDataTools::ToNeuroInfo(const ros2neuro_msgs::msg::NeuroDataInfo& msg, NeuroDataInfo& info) {
...
bool NeuroDataTools::FromNeuroFrame(const NeuroFrame& frame, ros2neuro_msgs::msg::NeuroFrame& msg) {
...
bool NeuroDataTools::ToNeuroFrame(const ros2neuro_msgs::msg::NeuroFrame& msg, NeuroFrame& frame) {
...
bool NeuroDataTools::FromNeuroData(const NeuroData<float>& data, ros2neuro_msgs::msg::NeuroDataFloat& msg) {
...
bool NeuroDataTools::FromNeuroData(const NeuroData<int32_t>& data, ros2neuro_msgs::msg::NeuroDataInt32& msg) {
...
bool NeuroDataTools::ToNeuroData(const ros2neuro_msgs::msg::NeuroDataFloat& msg, NeuroData<float>& data) {
...
bool NeuroDataTools::ToNeuroData(const ros2neuro_msgs::msg::NeuroDataInt32& msg, NeuroData<int32_t>& data) {
